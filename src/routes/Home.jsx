...
import Imagem2 from '../assets/image2.webp'
        ...
        <main>
            <article className='produto-grid'>
                ...
                <section className='produto-item span-row-2 span-col-2'>
                    <img src={Imagem2} alt="produto-5" id='image' />
                    <div>
                        <h3>Produto-5</h3>
                        <p>R$500.00</p>
                    </div> 
                ...
                <section className='produto-item'>
                    <img src={Imagem3} alt="produto-6" id='image' />
                    <div>
                        <h3>Produto-6</h3>
                        <p>R$600.00</p>
                    </div> 
                ...
                <section className='produto-item'>
                    <img src={Imagem4} alt="produto-7" id='image' />
                    <div>
                        <h3>Produto-7</h3>
                        <p>R$700.00</p>
                    </div> 
                ...
                <section className='produto-item'>
                    <img src={Imagem4} alt="produto-10" id='image' />
                    <div>
                        <h3>Produto-10</h3>
                        <p>R$1000.00</p>
                    </div> 
